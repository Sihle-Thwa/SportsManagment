          ...
          return (
            <>
              ...
              >
                ...
                >
                  <SelectValue className="field__select-value" placeholder={placeholder} />
                </SelectTrigger>
                <SelectContent className="field__select-content">
                  {options.map((o) => (
                    <SelectItem className="field__select-item" key={o.value} value={o.value}>
                      {o.label}
                    </SelectItem>
                  ))}
                </SelectContent>

  ...
  return (
    <div className="cardBase_fileUpload">
      <div className="cardHeader_fileUpload">
        <div className="cardHeader-content_fileUpload_Profile">
          <User className="cardHeader-content_fileUpload_Icon" />
        </div>
      </div>
        ...
        {!selectedFile ? (
          <>
            ...
            >
              ...
              />
              <label htmlFor="file-upload" className="fileDropzone-label">
                <Upload className="fileDropzone-icon" />
            ...
            <div className="footerActions_fileUpload">
              <button
                className="buttonAdd_fileUpload"
          ...
          <>
            ...
            <div className="footerActions_fileUpload">
              <button className="buttonRemove_fileUpload" onClick={handleRemove}>
                Remove
              </button>
            </div>
          </>
